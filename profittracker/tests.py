...
class ProductViewTests(TestCase):
    ...
    def test_product_list_renders_for_owner(self):
        ...
        self.assertContains(response, "黒字ライン")
    ...
    def test_analytics_renders_charts_and_insights(self):
        ...
        self.assertContains(response, "売却済み商品一覧")
        ...
        self.assertContains(response, "Profitable Lens")
        self.assertContains(response, "実売価格")
        self.assertContains(response, "Mercari")
